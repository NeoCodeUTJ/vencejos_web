    ...
    <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-xl rounded-2xl -mt-64">
        ...
        <Card>
            <CardHeader color="pink" contentPosition="center">
                <h2 className="text-white text-4xl font-serif font-bold leading-normal mt-0 mb-2 ">Envios</h2>
            </CardHeader>
            <CardBody>
                    ...
                    <table className="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                {/*Comentarios*/}
                                <th className="border-b border-gray-200 align-middle font-bold text-sm whitespace-nowrap px-2 py-4 text-center">
